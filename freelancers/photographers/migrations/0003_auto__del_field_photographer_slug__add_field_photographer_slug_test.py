...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'photographers.photographer': {
            ...
            'slug_test': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'tagline': ('django.db.models.fields.TextField', [], {}),
            'test_field': ('django.db.models.fields.SlugField', [], {'default': "'test'", 'max_length': '255', 'blank': 'True'}),
