...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tutors_tutor', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['categories.Category'])),
    ...
    models = {
        ...
        u'tutors.tutor': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['categories.Category']"}),
